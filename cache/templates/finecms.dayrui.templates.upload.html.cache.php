	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			swfu = new SWFUpload({
				...
				upload_url:"/index.php?s=member&c=api&m=swfupload",
				file_post_name : "Filedata",
				post_params:{"session":"<?php echo $session; ?>", "code":"<?php echo $code; ?>", "fileid":"<?php echo $fileid; ?>", "siteid":"<?php echo $siteid; ?>", "path":"<?php echo $path; ?>"},
